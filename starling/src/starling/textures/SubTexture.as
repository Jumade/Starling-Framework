...
/** A SubTexture represents a section of another texture. This is achieved solely by
    ...
    public class SubTexture extends Texture
    {
                                   ...
                                   rotated:Boolean=false)
        {
         ...
         //   x="436" y="416" width="104" height="72" frameX="-7" frameY="-36" frameWidth="124" frameHeight="124"/>
        }
        /** @inheritDoc */
        ...
        public override function getUVData():void
        {
           ...
           while (texture)
           {
            ...
            MatrixUtil.transformCoords(sMatrix, 0, 0, sTexCoords);
            uvMapping.x =  sTexCoords.x;
            uvMapping.y =  sTexCoords.y;
            MatrixUtil.transformCoords(sMatrix, 1, 1, sTexCoords);
            uvMapping.width =  sTexCoords.x -  uvMapping.x;
            uvMapping.height =  sTexCoords.y -  uvMapping.y;
        ...
        /*
        public override function applyFrame(vertexData:VertexData, vertexID:int, count:int):void
        {
            var startIndex:int = vertexID * VertexData.ELEMENTS_PER_VERTEX + VertexData.TEXCOORD_OFFSET;
            var stride:int = VertexData.ELEMENTS_PER_VERTEX - 2;
        ...
        */
        ...
        public override function get originalFrame():Rectangle
        {
            return mFrame;
        }
    }
